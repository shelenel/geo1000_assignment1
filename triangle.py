...
# CW or CCW
clockwise = counter_clockwise = False
...
def triangle_area(xa, ya, xb, yb, xc, yc):
    ...
    #print(area) # Used for test execution calls
    return area
...
#triangle_area(0, 0, 10, 0, 0, 10)    # Expected output: 50.0
#triangle_area(3, 4, 1, 1, 4, 1)      # Expected output: 4.5